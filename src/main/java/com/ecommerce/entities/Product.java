...
public class Product {
    ...
    public Product(int productId, String productName, String productDescription, float productPrice, int productDiscount, int productQuantity, String productImages, int categoryId){
        super();
    ...
    public String toString(){
        ...
        + ", productDiscount=" + productDiscount + ", productQuantity=" + productQuantity + ", productImages=" + productImages + ", categoryId=" + categoryId + "]";
    }
}
